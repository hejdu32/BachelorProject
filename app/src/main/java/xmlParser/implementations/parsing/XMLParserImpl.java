...
public class XMLParserImpl implements XMLParser {
    ...
    public void parse(String path) throws FileNotFoundException {
        InputStream inputStream = new FileInputStream("C:/proj/BachelorProject/resources/malta-latest.osm.pbf");
        ...
        try {
            ...
            InputStream inputStream1 = new FileInputStream("C:/proj/BachelorProject/resources/malta-latest.osm.pbf");
